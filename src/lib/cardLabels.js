...
// Path to a Korean-aware OTF served from /public/fonts. drei's <Text>
// component accepts a font URL and renders it via troika-three-text.
export const KOREAN_FONT = '/fonts/Pretendard-Regular.otf';
